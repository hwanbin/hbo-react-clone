...
const FeaturedMedia = (props) => {
  return(
    <div className="featured-media">
      ...
      width="100%"
      height="100%"
      src="https://www.youtube.com/embed/NYH2sLid0Zc?autoplay=1&loop=1&mute=1&start=16"
      ...
      <div className="featured-media__bg">
        <div className="featured-media__container">
          ...
          <div className="featured-media__location">In theaters and HBO MAX. Streaming throughout May 23.
          </div>
